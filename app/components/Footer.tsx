  ...
  return (
    <footer className="bg-black text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-gray-800 pb-12">
          ...
          <div className="flex flex-col gap-8">
            <div className="flex items-start gap-4">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-300 font-bold">Milind Madhukar Jori -</p>
                  <p className="text-sm text-gray-400">Cofounder</p>
                  <p className="text-sm text-gray-400 font-semibold">+91 9689971271</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              <div className="flex flex-col gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-300 font-bold">Rameshwari Milind Jori -</p>
                  <p className="text-sm text-gray-400">Proprietor/ Founder</p>
                  <p className="text-sm text-gray-400 font-semibold">+91 9371758355</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 font-semibold text-sm">
              ...
              <li><Link href="/#exports" className="text-gray-400 hover:text-white transition-colors">Shrim Exports</Link></li>
              <li><Link href="/product-catalogue" className="text-gray-400 hover:text-white transition-colors">Product Catalogue</Link></li>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 text-sm text-gray-400 font-semibold">
                ...
                <a href="mailto:rameshwarijori@shrimexport.com" className="hover:text-white transition-colors">rameshwarijori@shrimexport.com</a>
              </div>
              <div className="flex items-center gap-3 text-sm text-gray-400 font-semibold">
                <svg className="w-5 h-5 text-gray-400 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-8 text-center text-xs text-gray-500 font-semibold tracking-wider">
          <p>Shrim All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
